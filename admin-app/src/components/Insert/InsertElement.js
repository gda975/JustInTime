...
import { getPostNumber, writeData, updatePostNumber } from '../../firebase/FirebaseAPI';
...
export default function InsertElement(props) {
    ...
    const handleInsert = () => {
        ...
        // send notification!
        notificationRequest(title, insertInput, currentValue)
        props.callback();
    };
    
    const notificationRequest = (title, notificationBody, topic) => {
